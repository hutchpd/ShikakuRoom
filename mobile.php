...
function printme(){
arent.window.frames["iframe"].focus();
...
<!--<script src="js/jquery.mobile-1.4.0.min.js" language="javascript" type="text/javascript" ></script>-->
<script src="./js/shikaku.js" language="javascript" type="text/javascript" /></script>
<link rel="stylesheet" type="text/css" href="shikaku2.css" />
<link rel="stylesheet" type="text/css" href="js/jquery.mobile-1.4.0.min.css" />
</head>
<!--
<?php
		foreach ($val as $v){
...
<table border="2" cellspacing="0" cellpadding="0" id="shikaku" ontouchcancel="fixme();" ontouchstart="hitme();" class="shikaku">
  <caption>
    Shikaku Puzzle
  </caption>
  	<?php
		for ($i = 0; $i <= $height; $i++) {
			...
			for ($j = 0; $j <= $width; $j++) {
				echo "<td id=\"cellw$i";
				echo "h$j\" ontouchmove=\"x=$i;y=$j;lightme()\">";
				foreach($val as $v){
					if($v[0]==$j&&$v[1]==$i){
						echo "$v[2]";
					}
